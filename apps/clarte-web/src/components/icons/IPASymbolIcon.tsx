  ...
  return (
    <div className="p-[2px] rounded-full bg-gradient-to-br from-[#ffffff40] to-[#ffffff10]">
      <div
        ref={props.ref || null}
        className={cn(
          'w-12 h-12 flex items-center justify-center text-center text-2xl hover:text-emerald-500 font-ipa rounded-full text-emerald-400',
...
IPASymbolIcon.displayName = 'IPASymbolIcon'; // what's if for
